...
VALUES
    ...
    ('Yoga Vespertino', 'S�bado 9:00-10:30 AM', 20, 25, 1),
...
('Bicicleta Est�tica Schwinn IC4', '2023-02-10 10:30:00', 'Operativo', '2023-02-10 10:30:00', '2023-02-10 10:30:00', 'admin_gym'),
('El�ptica NordicTrack Commercial 14.9', '2023-02-20 11:15:00', 'En Mantenimiento', '2023-02-20 11:15:00', '2024-11-25 14:20:00', 'tecnico_mantenimiento'),
...
('Banco Press Banca Ol�mpico', '2023-01-20 10:00:00', 'Operativo', '2023-01-20 10:00:00', '2023-01-20 10:00:00', 'admin_gym'),
('M�quina Smith Precor', '2023-02-15 11:30:00', 'Operativo', '2023-02-15 11:30:00', '2023-02-15 11:30:00', 'admin_gym'),
...
('M�quina Pectoral Fly Technogym', '2023-03-25 10:45:00', 'Operativo', '2023-03-25 10:45:00', '2023-03-25 10:45:00', 'admin_gym'),
('Multiestaci�n Body-Solid EXM3000LPS', '2023-04-10 12:00:00', 'Operativo', '2023-04-10 12:00:00', '2023-04-10 12:00:00', 'admin_gym'),
('Set Mancuernas 5-50 lbs (Par)', '2023-05-01 08:00:00', 'Operativo', '2023-05-01 08:00:00', '2023-05-01 08:00:00', 'admin_gym'),
('Bal�n Medicinal 10 kg Rogue', '2023-05-15 10:30:00', 'Operativo', '2023-05-15 10:30:00', '2023-05-15 10:30:00', 'admin_gym'),
...
('Barras Ol�mpicas 20 kg (3 unidades)', '2023-08-15 08:15:00', 'Fuera de Servicio', '2023-08-15 08:15:00', '2024-11-22 09:00:00', 'tecnico_mantenimiento');
...
VALUES 
(1, 5, '2024-03-15 08:30:00', 'Mantenimiento preventivo: lubricaci�n de banda, ajuste de velocidad y limpieza general', 85.00, '2024-03-15 08:30:00', 'tecnico_mantenimiento'),
(2, 16, '2024-03-20 10:15:00', 'Mantenimiento preventivo: revisi�n de sistema el�ctrico y calibraci�n de display', 75.00, '2024-03-20 10:15:00', 'tecnico_mantenimiento'),
(3, 5, '2024-04-10 09:00:00', 'Limpieza profunda y lubricaci�n de pedales, ajuste de resistencia', 60.00, '2024-04-10 09:00:00', 'tecnico_mantenimiento'),
(5, 28, '2024-04-25 14:30:00', 'Mantenimiento preventivo: lubricaci�n de cadena, revisi�n de escalones', 95.00, '2024-04-25 14:30:00', 'tecnico_mantenimiento'),
(6, 16, '2024-05-05 11:00:00', 'Revisi�n general, lubricaci�n de rieles y ajuste de tensi�n', 70.00, '2024-05-05 11:00:00', 'tecnico_mantenimiento'),
(4, 5, '2024-06-12 08:45:00', 'Reparaci�n de sensor de frecuencia card�aca y reemplazo de cable de alimentaci�n', 125.50, '2024-06-12 08:45:00', 'tecnico_mantenimiento'),
(7, 28, '2024-06-18 13:20:00', 'Reemplazo de pi��n desgastado y ajuste de sistema de frenado', 180.00, '2024-06-18 13:20:00', 'tecnico_mantenimiento'),
...
(10, 5, '2024-07-15 10:45:00', 'Reparaci�n de sistema hidr�ulico y reemplazo de pist�n defectuoso', 310.75, '2024-07-15 10:45:00', 'tecnico_mantenimiento'),
(20, 28, '2024-08-01 08:00:00', 'Reemplazo de barra con fisura, inspecci�n de seguridad completa', 450.00, '2024-08-01 08:00:00', 'tecnico_mantenimiento')
...
BEGIN
    ...
    SET @Metodo_pago = CASE (ABS(CHECKSUM(NEWID())) % 5) + 1
        ...
        WHEN 2 THEN 'Tarjeta de Cr�dito'
        WHEN 3 THEN 'Tarjeta de D�bito'
    ...
    -- Periodo basado en la fecha de pago (MES y A�O coinciden con @Fecha_pago)
